...
This backlog implements `ROADMAP.md` and the frozen architecture in `ARCHITECTURE.md`/`ARCHITECTURE_DECISIONS.md`. Updated 2026-08-06 to incorporate the required and recommended changes from the pre-implementation Architecture Review.
...
| T4-09 | Enforce and measure latency budgets (~800ms voice, ~2s text first-token) as CI/manual acceptance checks | P1 | T4-01 |
